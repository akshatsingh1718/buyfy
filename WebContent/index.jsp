...
<body>
	...
	<div class="container">
		...
		<c:if test="${sessionScope.categories[0] ne null}">
		...
		<c:if test="${sessionScope.categories[1] ne null}">
		...
		<c:if test="${sessionScope.categories[2] ne null}">
		<section class="body-font">
			<div class="container px-5 py-20 mx-auto">
				<h1 class="text-2xl p-3 bg-purple-500 text-light mb-4">
					<b>Top deals on
		...
		<c:if test="${sessionScope.categories[3] ne null}">
		<section class="body-font">
			<div class="container px-5 py-20 mx-auto">
				<h1 class="text-2xl p-3 bg-purple-500 text-light mb-4">
					<b>Top deals on
		...
		<c:if test="${sessionScope.categories[4] ne null}">
		<section class="body-font">
